...
class Dropdown extends Component {
    ...
    render() {
        ...
        const dropdownItems = this.props.items.map(it => {
            ...
            const iCls = "far " + (it.id === this.state.selected.id ? "fa-check-square" : "fa-square")
            return (
                <button className="button dropdown-item is-white" key={it.id} href="#"
            ...
            <div className="dropdown is-hoverable is-right">
              ...
              <span className="icon">
                <i className={this.props.icon}/>
                        ...
                        <span>{this.state.selected.id === null ? this.props.noSelectionText : this.state.selected.text}</span>
                    </button>
                </div>
